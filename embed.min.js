(function() {
    ...
    const defaultConfig = {
        ...
        chat: {
            size: "52px",
            logo: "https://221160ec90288b67394305daa4da6352.cdn.bubble.io/f1737572394496x724354179088600/embedlogo.png",
    ...
    iframe.style.bottom = `${parseInt(config.chat.size, 10) + 15}px`;
    ...
    let isOpen = localStorage.getItem("chatbotState") === "open" ? true : false;

    function openIframe() {
        iframe.style.transform = "scale(1)";
        iframe.style.opacity = "1";
        iframe.style.pointerEvents = "auto";
        iframe.style.bottom = `${parseInt(config.chat.size, 10) + 60}px`;
    ...
    const setResponsiveStyles = () => {
        if (window.innerWidth <= 600) {
            chat.style.width = "48px";
            iframe.style.width = "90%";
            iframe.style.height = "500px";
        } else if (window.innerWidth <= 1024) {
            chat.style.width = "52px";
